...
def ai_generate():
    ...
    basic_spices = {
        "english": ["salt", "black pepper", "olive oil", "vegetable oil"],
        "russian": ["соль", "черный перец", "оливковое масло", "растительное масло"],
        "kazakh": ["тұз", "қара бұрыш", "зейтүн майы", "өсімдік майы"]
    }
